...
Scenario(
  'PMM-T358 Verify Failed checks panel at Home page for the viewer role (STT is enabled) @not-pr-pipeline @group1',
...
Scenario(
  'PMM-T360 Verify Failed checks panel at Home page for the admin role (STT is enabled) @not-pr-pipeline @group1',
  async (I, homePage, settingsAPI) => {
    await settingsAPI.apiEnableSTT();
...
Scenario(
  'PMM-T358 Verify Database Failed checks page for the viewer role (STT is enabled) [critical] @not-pr-pipeline @group1',
...
Scenario(
  'PMM-T360 Verify Database Failed checks page for the admin role (STT is enabled) [critical] @not-pr-pipeline @group1',
  async (I, databaseChecksPage, settingsAPI) => {
    await settingsAPI.apiEnableSTT();
    await I.Authorize(users.admin.username, users.admin.password);
    I.amOnPage(databaseChecksPage.url);
...
Scenario(
  'PMM-T358 Verify Failed checks panel at Home page for the viewer role (STT is disabled) @not-pr-pipeline @group1',
  async (I, homePage, settingsAPI) => {
...
Scenario(
  'PMM-T360 Verify Failed checks panel at Home page for the admin role (STT is disabled) @not-pr-pipeline @group1',
  async (I, homePage, settingsAPI) => {
    await settingsAPI.apiDisableSTT();
    await I.Authorize(users.admin.username, users.admin.password);
    I.amOnPage(homePage.url);
...
Scenario(
  'PMM-T358 Verify Database Failed checks page for the viewer role (STT is disabled) [critical] @not-pr-pipeline @group1',
  async (I, databaseChecksPage, settingsAPI) => {
    await settingsAPI.apiDisableSTT();
    await I.Authorize(users.viewer.username, users.viewer.password);
    I.amOnPage(databaseChecksPage.url);
...
Scenario(
  'PMM-T360 Verify Database Failed checks page for the admin role (STT is disabled) [critical] @not-pr-pipeline @group1',
  async (I, databaseChecksPage, settingsAPI) => {
    await settingsAPI.apiDisableSTT();
    await I.Authorize(users.admin.username, users.admin.password);
    I.amOnPage(databaseChecksPage.url);
